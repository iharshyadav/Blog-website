        ...
        <div className="hidden xl:block">
          <div className="relative flex items-end  px-4 pb-10 pt-60 sm:px-6 sm:pb-16 md:justify-center lg:px-8 lg:pb-24">
            <div className="absolute inset-0 xl:block hidden">
              <Image
                className="h-full w-full rounded-md object-cover object-top xl:block hidden"
                src="https://images.pexels.com/photos/4865545/pexels-photo-4865545.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                alt=""
                fill
              />
            </div>
            <div className="absolute xl:block hidden inset-0 bg-gradient-to-t from-black to-transparent"></div>
            <div className="relative ">
              <div className="w-full xl:block hidden max-w-xl xl:mx-auto xl:w-full xl:max-w-xl xl:pr-24">
